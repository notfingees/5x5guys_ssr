  ...
  <section id="about">
    ...
    <div class="fbf_left" id="hide-mobile">
      ...
      <p class="fivebyfive_details">
        ...
        directly (as text) on the Ethereum blockchain as an ERC721 NFT. <br><br>There's no minting fees; learn more below and write your own 
        5X5GUY today!
...
`---’
    ...
    <div class="as_right">
      ...
      <span class="stats_span"><p class="stats_number">5,555 </p><p class="stats_description">SUPPLY</p></span>
       <span class="stats_span"><p class="stats_number">5,552 </p><p class="stats_description">REMAINING</p></span>
        <span class="stats_span"><p class="stats_number">0Ξ </p><p class="stats_description">MINT PRICE*</p><p style="margin-top:-1vh;" id="about_stats_asterix" class="hide-mobile">Not counting In Writing, Ethereum (gas) fees</p></span>
        <span class="stats_span"><p class="stats_number">100% </p><p class="stats_description">ON CHAIN</p></span>
         <span class="stats_span"><p class="stats_number">6 </p><p class="stats_description">TOTAL TRANSACTIONS</p></span>
          <span class="stats_span"><p class="stats_number">1.4Ξ </p><p class="stats_description">TOTAL SALES</p></span>
...
*/
      ...
      //  console.log(parseInt(scrollPercent))
       ...
       //   console.log("in the else if")
          this.$data.currently_shown_fivebyfive_animated_index = parseInt(scrollPercent) % 36 + 1;
        }
        else {
       ...
       // this.$data.currently_shown_fivebyfive_animated_index = parseInt(scrollPercent) % 39 + 1;
        /*
        if (this.$data.fivebyfive_animated[this.$data.currently_shown_fivebyfive_animated_index] === undefined){
          console.log("undefined with", this.$data.currently_shown_fivebyfive_animated_index)
        }
        */
    ...
    //  const contract = require("@/assets/_5x5guys.json")
      const contractAddress = "0x32b31A5232469014939ce5569e72683cbd0efaDb"
   //   const nftContract = new web3.eth.Contract(contract.abi, contractAddress)
    ...
    async mint(s){
      ...
      s = String.raw`${this.unraw(this.$data.five_hundred_nfts[this.$data.current_landing_donny_index])}`
  ...
  computed: {
    three_row_pattern: function () {
      ...
      console.log("three row pattern has", return_array.length)
      console.log("first is", return_array[0])
      return return_array;
    }
  },
  mounted: function () {
